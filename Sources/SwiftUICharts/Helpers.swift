...
public struct ChartForm {
    ...
    public static let medium = CGSize(width: (UIScreen.main.bounds.width / 2) - 15, height: chartHeight)
    public static let large = CGSize(width: UIScreen.main.bounds.width - 20, height: chartHeight)
