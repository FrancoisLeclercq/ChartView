...
public struct ChartForm {
    ...
    public static let medium = CGSize(width: Int((UIScreen.main.bounds.width / 2) - 15), height:220)
    public static let large = CGSize(width:Int(UIScreen.main.bounds.width - 20), height:220)
